...
ParserVTable :: struct {
	...
	WHILE:                proc(p: ^Parser) -> (NODEID, OuauError),
	REPEAT:               proc(p: ^Parser) -> (NODEID, OuauError),
	DO:                   proc(p: ^Parser) -> (NODEID, OuauError),
	IF:                   proc(p: ^Parser) -> (NODEID, OuauError),
	FUNCTION:             proc(p: ^Parser) -> (NODEID, OuauError),
	FOR:                  proc(p: ^Parser) -> (NODEID, OuauError),
	LOCAL:                proc(p: ^Parser) -> (NODEID, OuauError),
	GLOBAL:               proc(p: ^Parser) -> (NODEID, OuauError),
	BREAK:                proc(p: ^Parser) -> (NODEID, OuauError),
	RETURN:               proc(p: ^Parser) -> (NODEID, OuauError),
	CALL:                 proc(p: ^Parser) -> (NODEID, OuauError),
	EXPRESSION_STATEMENT: proc(p: ^Parser) -> (NODEID, OuauError),
	PREFIX_EXP:           proc(p: ^Parser) -> (NODEID, OuauError),
